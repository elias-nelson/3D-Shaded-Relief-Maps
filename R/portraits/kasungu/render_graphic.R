...
swatchplot(colors)
#'   
texture <- grDevices::colorRampPalette(colors = colors)(256)
#'  
swatchplot(texture)
#'  
...
out_file <- str_to_lower(glue("images/{map}/{map}_{pal}_z{z}.png"))
#' 
...
#' # Wrap the code below in brackets '{}' so it runs as a chunk  
{
  ...
  rayshader::render_highquality(
    ...
    width = 5000, height = 5000 # This effectively sets the resolution of the final graphic
  )
  end_time <- Sys.time()
